...
class MetadataInputDelegate extends BaseMetadataDelegate {
   ...
   */
  List<MetadataResult<ParameterMetadataDescriptor>> getParametersMetadataDescriptors(MetadataContext context, Object key) {
    return component.getParameterModels().stream()
      .map(p -> getInputMetadataDescriptor(p, context, key))
   ...
   */
  private MetadataResult<ParameterMetadataDescriptor> getInputMetadataDescriptor(ParameterModel parameter,
                                                                                 MetadataContext context, Object key) {

    MetadataResult<MetadataType> inputMetadataResult = getInputMetadata(parameter, context, key);
    ParameterMetadataDescriptor descriptor = parameterDescriptor(parameter.getName())
      .withType(inputMetadataResult.get()).build();
   ...
   */
  private MetadataResult<MetadataType> getInputMetadata(ParameterModel parameter, MetadataContext context, Object key) {
